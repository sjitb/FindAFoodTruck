...
The goal was to utilize most of the functionalities of the Socrata API
The base url for the API call is :`http://data.sfgov.org/resource/bbb8-hzi6.json`
The built in filters utalized:
